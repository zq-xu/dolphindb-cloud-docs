...
Kubernetes也可以部署在单台节点上([Minikube](./installer/minikube.md))，或者部署在单个容器里([Kind](https://kind.sigs.k8s.io/))。

## 架构概览

![Kubernetes高可用集群整体架构](/images/reference/kubernetes/kubernetes-high-level-component-archtecture.jpeg)
